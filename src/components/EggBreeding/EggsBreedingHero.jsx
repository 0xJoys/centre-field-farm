...
const EggsBreedingHero = () => {
  return (
    <div className="bg-right bg-[url('src/assets/EggsBreedingHeroImg.png')] w-full  h-screen  flex flex-col justify-center items-center mb-20 borde">
...
export default EggsBreedingHero;
